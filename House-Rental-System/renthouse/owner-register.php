...
include("navbar.php");
?>
<link rel="stylesheet" href="css/owner-register.css">
<div class="container">
  ...
  <form method="POST" action="owner-engine.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" placeholder="Enter password" name="id_photo" accept="image/*"
    ...
    <hr>
    <center><button id="submit" name="owner_register" class="btn btn-primary btn-block"
