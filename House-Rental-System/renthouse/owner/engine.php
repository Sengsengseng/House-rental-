...
function add_property(){
	...
	global $property_id,$country,$province,$zone,$district,$city,$contact_no,$property_type,$estimated_price,$total_rooms,$bedroom,$living_room,$kitchen,$bathroom,$description,$latitude,$path,$p_photo,$property_photo_id,$longitude,$owner_id,$booked,$db;
	...
	$latitude=validate($_POST['latitude']);
        ...
        if(mysqli_num_rows($result1)>0)
      {
   	...
   	$sql = "INSERT INTO add_property(country,province,zone,district,city,contact_no,property_type,estimated_price,total_rooms,bedroom,living_room,kitchen,bathroom,description,latitude,longitude,booked,owner_id) VALUES('$country','$province','$zone','$district','$city','$contact_no','$property_type','$estimated_price','$total_rooms','$bedroom','$living_room','$kitchen','$bathroom','$description','$latitude','$longitude','$booked','$owner_id')";
