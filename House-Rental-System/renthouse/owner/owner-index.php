          ...
          if (mysqli_num_rows($result) > 0) {
            while ($rows = mysqli_fetch_assoc($result)) {
              ...
              <div class="card">
                ...
                <img src="../<?php echo $rows['id_photo']; ?>" style="height:200px; width: 100%">
                <h1>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <select id="district-dropdown" data-live-search="true" class="form-control" name="district"
                    required="required">
                  ...
                  <tr>
                    ...
                    <form method="POST">
                      <td>
                        ...
                        <a style="margin: 1px" data-toggle="pill" class="btn btn-success" name="edit_property"
                          onclick="<?php $property_id = $rows['property_id'] ?>" href="#menu5">Edit</a>
